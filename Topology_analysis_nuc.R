...
setwd("/Users/esforsythe/Documents/Beilstiein_lab_research/BIOINFORMATICS/Brassicaceae_Phylo/0_170207_REDO_w_Chir/RAxML_results_170213")
...
####Make a function to analyze tree topologies in high-throughput
...
#"Loose" refers to topologies designated based on monophyly of the clades B+C, A+C, A+B.
...
#export a CSV file
write.csv(output_df, file = "topology_results_170214.csv")
