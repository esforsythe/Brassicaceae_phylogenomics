...
setwd("/Users/esforsythe/Documents/Beilstiein_lab_research/BIOINFORMATICS/Brassicaceae_Phylo/0_170207_REDO_w_Chir/170329_Chir_CP")
...
trees<-read.tree("Catfile_CPtrees_wChir170330")
Ntrees<-length(trees)
...
#Note: I visually inspeced trees and removed a couple with dublicate Ch sequences

#Apply the quick function
lapply(trees, PlotTreesFunc)


### MAKE A FUNCTION FOR TOPOLOGY ANALYSIS ###
...
AB_hist<-hist(as.numeric(as.vector(boots_AB$Bootstrap_Support)), breaks=30)
...
#export a CSV file
write.csv(output_df, file = "CPwChir_topology_results_170331.csv")
